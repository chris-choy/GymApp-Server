...
public class TokenProvider implements InitializingBean {
   ...
   private final long tokenValidityInMilliseconds = 24*60*60 * 1000; // 24h * 60min * 60s
   private final long tokenValidityInMillisecondsForRememberMe = 30*60*60 * 1000; // 30h * 60min * 60s
